 ...
 * @author User
 */
public class Z_ZorSoru implements ZorlukDegeri{
 private Connection baglanti;
    ...
    public Z_ZorSoru() {
          ...
          baglanti = abs.getImplementor().OpenCon(" z_ZorSoru Presenter");
    ...
    public void ZorlukDegeri() {
        ...
        int toplamSoru =Integer.parseInt(form.getTxt_Soru_Sayisi().getText()) ;
           ...
           int k1 = (int) (toplamSoru *0.2);
           int k2 = (int) (toplamSoru *0.3);
           int k3 = (int) (toplamSoru *0.5);
